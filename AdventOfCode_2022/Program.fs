...
let main argv =
    ...
    printfn "Final result Day 10 part 1: %i" resultday10Part1
    printfn "Final result Day 10 part 2: " 
    day10_part02.execute
    ...
    printfn "Final result Day 13 part 2: %i" resultday13Part2
    ...
    printfn "Final result Day 16 part 1: %i" resultday16Part1
    let resultday16Part2 = day16_part02.execute
    printfn "Final result Day 16 part 2: %i" resultday16Part2
    ...
    printfn "Final result Day 20 part 1: %i" resultday20Part1
    ...
    printfn "Final result Day 25 part 1: %s" resultday25Part1
    let resultday25Part2 = day25_part02.execute
    printfn "Final result Day 25 part 2: %i" resultday25Part2
