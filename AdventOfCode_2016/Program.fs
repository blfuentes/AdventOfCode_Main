...
let main argv =
    ...
    printfn "Final result Day 02 part 1: %s" resultday02Part1
    ...
    printfn "Final result Day 05 part 1: %s" resultday05Part1
    let resultday05Part2 = day05_part02.execute
    printfn "Final result Day 05 part 2: %s" resultday05Part2

    // DAY 06
    let resultday06Part1 = day06_part01.execute
    printfn "Final result Day 06 part 1: %s" resultday06Part1
    let resultday06Part2 = day06_part02.execute
    printfn "Final result Day 06 part 2: %s" resultday06Part2

    // DAY 07
    let resultday07Part1 = day07_part01.execute
    printfn "Final result Day 07 part 1: %A" resultday07Part1
    let resultday07Part2 = day07_part02.execute
    printfn "Final result Day 07 part 2: %A" resultday07Part2

    // DAY 08
    let resultday08Part1 = day08_part01.execute
    printfn "Final result Day 08 part 1: %A" resultday08Part1
    printfn "Final result Day 08 part 2:" 
    day08_part02.execute

    // DAY 09
    let resultday09Part1 = day09_part01.execute
    printfn "Final result Day 09 part 1: %A" resultday09Part1
    ...
    printfn "Final result Day 13 part 1: %A" resultday13Part1
    ...
    printfn "Final result Day 20 part 1: %d" resultday20Part1
    let resultday20Part2 = day20_part02.execute
    printfn "Final result Day 20 part 2: %d" resultday20Part2
    ...
    printfn "Final result Day 21 part 2: %A" resultday21Part2

    // DAY 22
    let resultday22Part1 = day22_part01.execute
    printfn "Final result Day 22 part 1: %A" resultday22Part1
    let resultday22Part2 = day22_part02.execute
    printfn "Final result Day 22 part 2: %A" resultday22Part2

    // DAY 23
    let resultday23Part1 = day23_part01.execute
    printfn "Final result Day 23 part 1: %A" resultday23Part1
    let resultday23Part2 = day23_part02.execute
    printfn "Final result Day 23 part 2: %A" resultday23Part2

    // DAY 24
    let resultday24Part1 = day24_part01.execute
    printfn "Final result Day 24 part 1: %A" resultday24Part1
    let resultday24Part2 = day24_part02.execute
    printfn "Final result Day 24 part 2: %A" resultday24Part2
