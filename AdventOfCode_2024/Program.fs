...
let main argv =
    ...
    printfn "Final result Day 01 part 1: %A in %s" resultday02Part2 (ms time01_2)
    ...
    //printfn "Final result Day 07 part 1: %A in %s" resultday07Part1 (ms time07_1)
    //let (resultday07Part2, timer07_2) = Utilities.duration day07_part02.execute
    //printfn "Final result Day 07 part 2: %A in %s" resultday07Part2 (ms timer07_2)
    ...
    //printfn "Final result Day 11 part 2: %A in %s" resultday11Part2 (ms timer11_2)
    ...
    //printfn "Final result Day 13 part 2: %A in %s" resultday13Part2 (ms timer13_2)
