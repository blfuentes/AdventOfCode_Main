...
let main argv =
    ...
    printfn "Final result Day 02 part 1: %A" resultday02Part1
    ...
    // DAY 05
    let resultday05Part1 = day05_part01.execute 1I
    printfn "Final result Day 05 part 1: %A" resultday05Part1
    let resultday05Part2 = day05_part02.execute 5I
    printfn "Final result Day 05 part 2: %A" resultday05Part2
    ...
    let resultday10Part2 = day10_part02.execute [|27;19|]
    ...
    printfn "Final result Day 11 part 2:" 
    day11_part02.execute
