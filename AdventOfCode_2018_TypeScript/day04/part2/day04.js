...
exports.Day04Part02 = void 0;
const GuardEvent_1 = require("../GuardEvent");
class Day04Part02 {
    execute() {
        let fs = require("fs");
        ...
        function getMostSleepGuardValue(ids, guardInfo) {
            let guardId = 0;
            let maxTime = 0;
            let minute = 0;
            for (let id of ids) {
        ...
        function getMostRepeatedSleepGuardValue(ids, guardInfo) {
            let guardId = 0;
            let maxMinute = 0;
            let minute = 0;
            for (let id of ids) {
        ...
        for (let event of entryElements) {
            var tmpEvent = new GuardEvent_1.GuardEvent(event);
        ...
        for (let event of guardEvents) {
            ...
            if (tmpGuardId > -1) {
                ...
                if (eventsByGuardId[currentGuardId] == null) {
                    eventsByGuardId[currentGuardId] = new Array();
                    guardInfo[currentGuardId] = new GuardEvent_1.GuardInfo(currentGuardId);
                }
...
exports.Day04Part02 = Day04Part02;
